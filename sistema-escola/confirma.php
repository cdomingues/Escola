...
<div id="header">
   	  ...
   	  <div id="logo">
                	<h1>Creatif</h1>
          <small>A Family of Rockstar Wordpress Themes</small></div>
            ...
            <div id="block_featured" class="block">
              <div class="block_inside">
                <div class="text_block">
                  ...
                  <p>&nbsp;</p>
                        <br />
                        <a href="impressos/ficha_aluno2.php" class="button">imprimir ficha do aluno</a>
               	        <a href="impressos/autorizacao2.php" class="button">imprimir autorizaÇÕes</a></div>
